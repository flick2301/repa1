...
<div class="mdl" id="modalGreen">
	...
	<input type="hidden" name="NICE" value="Y" />
		<div class="mdl__box"> 
			<div class="mdl__name">Сообщение*</div>
			<textarea class="mdl__textarea"  name="TEXT" required="required"  value="Что больше понравилось?"></textarea>
		</div>
		<div class="mdl__box"> 
			<div class="mdl__name">Имя*</div>
			<input class="mdl__input" type="text" name="NAME" required="required"  placeholder="">
		</div>
		<div class="mdl__box"> 
			<div class="mdl__name">E-mail</div>
			<input class="mdl__input" type="email" name="EMAIL" placeholder="">
		</div>
		<div class="mdl__box"> 
			<div class="mdl__name">Телефон</div>
			<input class="mdl__input send-a-request__input phonemask" name="PHONE" type="tel" placeholder="+7">
		</div>
...
<div class="mdl" id="modalRed">
	...
	<div class="mdl__result"></div>	
		<div class="mdl__box"> 
			...
			<textarea class="mdl__textarea"  name="TEXT" required="required"  value="Как мы можем улучшить свою работу?"></textarea>
		</div>
		<div class="mdl__box"> 
			<div class="mdl__name">Имя*</div>
			<input class="mdl__input" type="text" name="NAME" required="required" placeholder="">
...
if (!$(this).children().children('[name=NAME]').val() || !$(this).children().children('[name=TEXT]').val()) {
