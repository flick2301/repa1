                     ...
                     <div class="simple-article__content">
                        ...
                        <section class="simple-article__section payment-option">
                           ...
                           <div class="payment-option__cover">
                              <img class="payment-option__icon" src="/local/templates/moskrep/assets/design/payment-option/credit-card.png" width="53" height="47" alt="">
                           </div>
                        </section>
                        <!--payment-option-->
                        <!--payment-option-->
                        ...
                        <section class="simple-article__section payment-option">
                           ...
                           <div class="payment-option__cover">
                              <img class="payment-option__icon" src="/local/templates/moskrep/assets/design/payment-option/cash-payment.png" width="52" height="47" alt="">
                           </div>
                        </section>
                        <!--payment-option-->
                        <!--payment-option-->
                        <section class="simple-article__section payment-option">
                           ...
                           <div class="payment-option__cover">
                              <img class="payment-option__icon" src="/local/templates/moskrep/assets/design/payment-option/wire-transfer.png" width="41" height="36" alt="">
                           </div>
                        </section>
                        <!--payment-option-->
                     </div>
