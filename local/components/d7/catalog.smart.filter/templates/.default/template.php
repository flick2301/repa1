		...
		<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
			...
			<div class="row">
							...
							switch ($arItem["DISPLAY_TYPE"])
							{
                                ...
                                <?elseif($arItem['CODE']==ID_PROPERTY_COUNT):?>
															...
															onclick="smartFilter.click(this)" class="checkbox__input"></div>
																			...
																			<?elseif($arItem['CODE']=="POKRYTIE" || $arItem['CODE']=="ZERNISTOST_P" || $arItem['CODE']=="GOLOVKA" || $arItem['CODE']=="MATERIAL" || $arItem['CODE']=="KONETS" || $arItem['CODE']=="REZBA" || $arItem['CODE']=="BREND" || $arItem['CODE']=="RAZMER_POD_KLYUCH_MM" || $arItem['CODE']=="KLASS_PROCHNOSTI" || $arItem['CODE']=="SHAG_REZBY_MM" || $arItem['CODE']=="DIN" || $arItem['CODE']=="GOST" || $arItem['CODE']=="SHLITS" || $arItem['CODE']=="PO_PRIMENENIYU"  || $arItem['CODE']=="VIDY_UPAKOVOK"):?>
																			<ul class="checkbox__items">
                                                                                <?foreach($arItem["VALUES"] as $val => $ar):?>
				...
				?>
                        ...
                        <a href="javascript:void(0);" rel="nofollow" onclick="BX('set_filter').click();" class="blue-btn main-filter__btn">Показать результат</a>
                        <div class="main-filter__center"><a rel="nofollow" onclick="BX('del_filter').click();" href="javascript:void(0);" class="main-filter__reset">Сбросить фильтр</a></div>
			</div><!--//row-->
                        <div id="tooltip"></div>
