				...
				<div class="slider__main owl-carousel">
					...
					<?foreach($arResult["ITEMS"][$arParams["MAIN_SECTION_ID"]] AS $val):?>
						...
						<a class="slider__link" href="<?=$val["PROPERTY"]["SLIDER_LINK"]["VALUE"]?>?banner_id=<?=$val['ID']?>">
							<img class="slider__img" loading="lazy" src="<?=$val["SMALL_IMG_WEBP_MOBILE"]['WEBP_SRC'] ? $val["SMALL_IMG_WEBP_MOBILE"]['WEBP_SRC'] : $val["SMALL_IMG_MOBILE"]["src"]?>">
							<img class="slider__img slider__img--mobile" loading="lazy" src="<?=$val["SMALL_IMG_WEBP_MOBILE"]['WEBP_SRC'] ? $val["SMALL_IMG_WEBP_MOBILE"]['WEBP_SRC'] : $val["SMALL_IMG_MOBILE"]["src"]?>">
						</a>
