		<div class="intro-slider__list" id="intro-slider__list">
			   ...
			   <?if($val["PROPERTY"]["DOMEN"]["VALUE"] ==false || in_array($_SERVER['HTTP_HOST'], $val["PROPERTY"]["DOMEN"]["VALUE"]))
			   {
						...
						<div class="intro-slider__item">
							<img class="intro-slider__image" <?=$count>1 ? "src='".$this->GetFolder()."/img/area.gif' data-" : ""?>src="<?=$val["SMALL_IMG_WEBP"]['WEBP_SRC'] ? $val["SMALL_IMG_WEBP"]['WEBP_SRC'] : $val["SMALL_IMG"]["src"]?>"  width="904" height="290" alt="<?=$val["PREVIEW_TEXT"]?>" title="<?=$val["PREVIEW_TEXT"]?>">
