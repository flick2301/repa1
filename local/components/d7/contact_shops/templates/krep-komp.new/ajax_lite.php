...
require_once($_SERVER["DOCUMENT_ROOT"].$templateFolder.'/result_modifier.php');
...
if ($arParams["SECTION_ID"]){
    ?><script src="<?=$templateFolder?>/js/script_<?=$arParams["SECTION_ID"]?>.js" /><?php
}
if ($arParams["SECTION_ID"]){
    ?><link href="<?=$templateFolder?>/css/style_<?=$arParams["SECTION_ID"]?>.css" type="text/css" rel="stylesheet"  /><?php
}
