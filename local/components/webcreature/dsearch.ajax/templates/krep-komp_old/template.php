...
<input name="text" type="text" value="<?=htmlspecialcharsEx($_GET['result'])?>" class="moskrep_input header-search__input" placeholder="<?=Loc::getMessage("DSEARCH_AJAX_SEARCH_ARTNO")?>" autocomplete="off" />			  
<div id="text_result">
</div>
</div>
