...
for($index = 0; $index < $itemSize; $index++)
{
	...
	$arrow = '<div class="bread__item">
              <div class="bread__arrow">›</div>
            </div>';

	if($arResult[$index]["LINK"] <> "" && $index != $itemSize-1)
	{
		$strReturn .= '
			<div class="bread__item" itemscope
      itemtype="http://schema.org/ListItem" class="crumbs-nav__item">
				
				<a itemprop="item" title="'.$title.'" href="'.$arResult[$index]["LINK"].'" target="_self"  class="bread__link">
