...
$arTemplateParameters["LIST_PREV_PIC_H_L2"] = array(
		"NAME" => GetMessage('LIST_PREV_PIC_H_L2'),
		"TYPE" => "STRING",
		"DEFAULT" => "100",
		
	);
$arTemplateParameters["LIST_PREV_PIC_W_L2"] = array(
		"NAME" => GetMessage('LIST_PREV_PIC_W_L2'),
		"TYPE" => "STRING",
		"DEFAULT" => "100",
		
	);
$arTemplateParameters["LIST_PREV_PIC_H_L3"] = array(
		"NAME" => GetMessage('LIST_PREV_PIC_H_L3'),
		"TYPE" => "STRING",
		"DEFAULT" => "100",
		
	);
$arTemplateParameters["LIST_PREV_PIC_W_L3"] = array(
		"NAME" => GetMessage('LIST_PREV_PIC_W_L3'),
		"TYPE" => "STRING",
		"DEFAULT" => "100",
		
	);
$arTemplateParameters["ITEMS_PREV_PIC_H_L3"] = array(
		"NAME" => GetMessage('ITEMS_PREV_PIC_H_L3'),
		"TYPE" => "STRING",
		"DEFAULT" => "100",
		
	);
$arTemplateParameters["ITEMS_PREV_PIC_W_L3"] = array(
		"NAME" => GetMessage('ITEMS_PREV_PIC_W_L3'),
		"TYPE" => "STRING",
		"DEFAULT" => "100",
		
	);
$arTemplateParameters["ITEMS_DETAIL_PIC_H"] = array(
		"NAME" => GetMessage('ITEMS_DETAIL_PIC_H'),
		"TYPE" => "STRING",
		"DEFAULT" => "100",
		
	);
$arTemplateParameters["ITEMS_DETAIL_PIC_W"] = array(
		"NAME" => GetMessage('ITEMS_DETAIL_PIC_W'),
		"TYPE" => "STRING",
		"DEFAULT" => "100",
...
$arTemplateParameters["VIBOR_CATALOG_TABLE"] = array(
         "PARENT" => "SETTINGS",
         "NAME" => 'Разделы в которых каталог в виде таблицы',
         "TYPE" => "LIST",
         "MULTIPLE"=>"Y",
         "ADDITIONAL_VALUES" => "Y",
         "VALUES" => $arIblockType,
