...
<aside id="bx-soa-total" class="two-column__left">
			...
			<div>
				<div id="bx-soa-main-notifications">
					...
					<div data-type="informer" style="display:none"></div>
                            ...
                            <!--	BUYER PROPS BLOCK	-->
				<div id="bx-soa-properties" data-visited="false" class="bx-soa-section content-feedback no-pad">
                                    <h2 class="s28-title"><?=$arParams['MESS_BUYER_BLOCK_NAME']?></h2>
                                    <br>
                                    <div class="bx-soa-section-content container-fluid feedback-form"></div>
				</div>
				<!--	AUTH BLOCK	-->
