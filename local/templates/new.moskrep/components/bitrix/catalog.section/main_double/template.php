...
<div class="product-card__artno-blok">
                        ...
                        <div class="product-card__header product-card__header_vi">
                         ...
                         <h3 class="product-card__title product-card__title_vi">
						 <a class="product-card__link product-card__link_vi" href="<?=$arElement[$key + 1]['DETAIL_PAGE_URL']?>" onclick="dataLayerProduct('<?=str_replace(Array("\"", "'"), "", htmlspecialchars($arResult['ITEMS'][$key + 1]['NAME']))?>')"><?=$arResult['ITEMS'][$key + 1]['NAME']?></a></h3>						   
                        </div>
