...
foreach($arResult['ITEMS'] as $key=>$arItem){
	...
	if($_SERVER['HTTP_HOST']=='spb.krep-komp.ru'){
		$arResult['ITEMS'][$key]['STORE'][$DEFAULT_STORE_ID]['AMOUNT'] = $arResult['ITEMS'][$key]['STORE'][$DEFAULT_STORE_ID]['AMOUNT']+$arResult['ITEMS'][$key]['STORE'][3]['AMOUNT']+$arResult['ITEMS'][$key]['STORE'][74]['AMOUNT'];
	}
