...
<?$intSectionID = $APPLICATION->IncludeComponent(
					...
					array(
						...
						"ELEMENT_SORT_FIELD" => 'property_DIAMETR',
						...
						'COMPATIBLE_MODE' => (isset($arParams['COMPATIBLE_MODE']) ? $arParams['COMPATIBLE_MODE'] : ''),
                                                'ITEMS_PREV_PIC_W_L3' => $arParams['ITEMS_PREV_PIC_W_L3'],
                                                'ITMES_PREV_PIC_H_L3' => $arParams['ITEMS_PREV_PIC_H_L3'],
                                                "VIBOR_CATALOG_TABLE" => $arParams["VIBOR_CATALOG_TABLE"],
