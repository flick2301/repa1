...
var result = deliveryCost.init({
	...
	if (delivery_id==ID_DELIVERY_DAYTODAY) {
		if (weight <= 15) result.cost = 500;
		else if (weight > 15 && weight <= 30) result.cost = 600;
		else if (weight > 30 && weight <= 100) result.cost = 1050;
		else if (weight > 100 && weight <= 200) result.cost = 1950;
		else if (weight > 200 && weight <= 500) result.cost = 3250;
		else if (weight > 500 && weight <= 1000) result.cost = 5100;
		else if (weight > 1000 && weight <= 3000) result.cost = 5850;
		else if (weight > 3000 && weight <= 5000) result.cost = 7150;
		else if (weight > 5000 && weight <= 10000) result.cost = 11700;
	}
	...
	if (delivery_id==ID_DELIVERY_SUNDAY) {
		...
		else if (weight > 100 && weight <= 300) result.cost = 3000;
	}	
