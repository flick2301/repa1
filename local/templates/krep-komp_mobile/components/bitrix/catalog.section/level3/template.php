			...
			<?}
					...
					<div class="catalog-table__column catalog-table__column--to-cart">
                           ...
                           <div class="catalog-table__content catalog-table__content--to-cart">
                              ...
                              <!--price-in-table-->
							  <input type="hidden" name="" data-quantity="<?=$item['CATALOG_QUANTITY']+$item['CATALOG_QUANTITY_RESERVED']?>" onchange='ChangeInputCart("<?=$item['NAME']?>", $(this))' id="QUANTITY_<?=$item['ID']?>" value="1" class="value__input">
