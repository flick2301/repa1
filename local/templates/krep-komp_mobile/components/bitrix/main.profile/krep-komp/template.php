...
<div class="user-notifications">
	  <div class="user-notifications__title">Уведомления на электронную почту</div>
	  <div class="user-notifications__item">
	  <input class="user-notifications__checkbox" type="checkbox" id="checkbox-1" name="" value="1" />
	  <label class="user-notifications__label" for="checkbox-1">Регистрация заказа</label>
	  </div>
	  <div class="user-notifications__item">
	  <input class="user-notifications__checkbox" type="checkbox" id="checkbox-2" name="" value="1" />
	  <label class="user-notifications__label" for="checkbox-2">Статус доставки</label>
	  </div>
	  <div class="user-notifications__item">
	  <input class="user-notifications__checkbox" type="checkbox" id="checkbox-3" name="" value="1" />
	  <label class="user-notifications__label" for="checkbox-3">Получать новостную рассылку</label>
	  </div>	 
	  </div>
	  
	  <div class="user-notifications">
	  <div class="user-notifications__title">Уведомления по СМС</div>
	  <div class="user-notifications__item">
	  <input class="user-notifications__checkbox" type="checkbox" id="checkbox-4" name="" value="1" />
	  <label class="user-notifications__label" for="checkbox-4">Регистрация заказа</label>
	  </div>
	  <div class="user-notifications__item">
	  <input class="user-notifications__checkbox" type="checkbox" id="checkbox-5" name="" value="1" />
	  <label class="user-notifications__label" for="checkbox-5">Статус доставки</label>
	  </div>
	  <div class="user-notifications__item">
	  <input class="user-notifications__checkbox" type="checkbox" id="checkbox-6" name="" value="1" />
	  <label class="user-notifications__label" for="checkbox-6">Получать новостную рассылку</label>
	  </div>	  
	  </div>
