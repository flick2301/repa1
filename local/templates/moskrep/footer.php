...
?>
   <script src="/local/templates/moskrep/js/jquery.min.js"></script>
   ...
   <script src="/local/templates/moskrep/assets/scripts/jquery.magnificpopup-1.1.0.min.js?v=XXXXXXa" defer="defer"></script>
