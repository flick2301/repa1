                  ...
                  <div class="product-slider__item">
                     ...
                     <section class="product-card product-card--lite">
                        ...
                        <div class="product-card__footer">
                           ...
                           <button onclick="dataLayerAddBasket('<?=str_replace(Array("\"", "'"), "", $item['NAME'])?>', '<?=$item['PRICES']['Распродажа']['VALUE']?>', 1)" data-product="<?=$item['ID']?>" data-name="<?=$item['NAME']?>" data-price="<?=$item['PRICES']['Распродажа']['VALUE']?>" class="main-button product-card__to-cart <?=($arResult['IN_BASKET'][$item['ID']] == 'Y') ? 'active' : "";?>"><i data-product="<?=$item['ID']?>" data-name="<?=$item['NAME']?>" data-price="<?=$item['PRICES']['Распродажа']['VALUE']?>" class="simple-cart-icon"></i>В корзину</button>
                        </div>
                     </section>
                     <!--product-card-->
                  </div>			   
