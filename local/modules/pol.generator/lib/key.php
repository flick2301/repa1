...
class Key extends Key\Base{
	...
	public static function add($fields = array() ){
		...
		$rsEvents = GetModuleEvents("pol.generator", "OnKeyAdd");
	...
	public static function addGroup($keys = array()){
		...
		$rsEvents = GetModuleEvents("pol.generator", "OnKeyAddGroup");
		while ($arEvent = $rsEvents->Fetch())
		{
	...
	public static function update($code, $fields){
		...
		$rsEvents = GetModuleEvents("pol.generator", "OnKeyUpdate");
		while ($arEvent = $rsEvents->Fetch())
		{
			ExecuteModuleEvent($arEvent, array(&$fields));
		}
	...
	public static function delete($codes){
		...
		$rsEvents = GetModuleEvents("pol.generator", "OnKeyDelete");
		while ($arEvent = $rsEvents->Fetch())
		{
	...
	public static function getList($keyNames = array()){
		...
		$rsEvents = GetModuleEvents("pol.generator", "OnKeysGetList");
		while ($arEvent = $rsEvents->Fetch())
		{
	...
	protected function canUse($key){
		$rsEvents = GetModuleEvents("pol.generator", "OnKeyCanUse");
		while ($arEvent = $rsEvents->Fetch())
		{
	...
	protected function validateFields($key){
		...
		$rsEvents = GetModuleEvents("pol.generator", "OnKeyValidFields");
		while ($arEvent = $rsEvents->Fetch())
		{
	...
	public static function addDefault(){
		...
		$rsEvents = GetModuleEvents("pol.generator", "OnKeyAddDefaults");
		while ($arEvent = $rsEvents->Fetch())
		{
	...
	public function setPagenKey(){
		...
		$rsEvents = GetModuleEvents("pol.generator", "OnSetPagenKey");
		while ($arEvent = $rsEvents->Fetch())
		{
			ExecuteModuleEvent($arEvent,array(&$return));
		}
