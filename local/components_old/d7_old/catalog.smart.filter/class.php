<?
//Принудительно поставил "PROPERTY_TYPE" => "S" чтобы все свойства рассматривались как строковые
//Принудительно поставил "DISPLAY_TYPE" => "F" чтобы все свойства в фильтре были в виде флажочков
