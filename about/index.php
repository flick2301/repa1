...
<?if(SITE_TEMPLATE_ID=='moskrep'){?>
            ...
            <div class="basic-layout__module simple-article">
               <div class="simple-article__content wysiwyg-block">
                  <p><img src="<?=SITE_TEMPLATE_PATH?>/uploads/simple-article/image-01.jpg" width="904" height="490" alt="КРЕП-КОМП"></p>
				  ...
				  <p><img src="<?=SITE_TEMPLATE_PATH?>/uploads/simple-article/image-01_2.jpg" width="904" height="603" alt="Склад"></p>
               </div>
            </div>
            <!--simple-article-->
<?}else{?>
